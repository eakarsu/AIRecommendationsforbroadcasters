...
export default function GapNoSportsDataApiIntegrationScoresStats() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-sports-data-api-integration-scores-stats', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No sports data API integration (scores, stats, live feeds)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIRecommendationsforbroadcasters - Gap feature</p>
