...
const FEATURE_SLUG = 'no-sports-data-api-integration-scores-stats';
const FEATURE_TITLE = 'No sports data API integration (scores, stats, live feeds)';
const PROJECT = 'AIRecommendationsforbroadcasters';
